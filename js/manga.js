    ...
    <div class="manga-detail">
      <div class="manga-detail-left">
        <img
          ...
          onerror="this.src='https://via.placeholder.com/300x450/1a1a1a/e63946?text=${encodeURIComponent(manga.titre)}'"
        >
      </div>
            ...
            ${manga.connexions.map(connexionId => {
              ...
              return `
                <div class="connexion-card" onclick="window.location.href='manga.html?id=${connexionManga.id}'">
                  <img src="${connexionManga.couverture}" alt="${connexionManga.titre}" class="connexion-cover" onerror="this.src='https://via.placeholder.com/60x90/1a1a1a/e63946?text=${encodeURIComponent(connexionManga.titre)}'">
          ...
          <div class="similar-grid">
            ${getRecommandations(manga).map(rec => `
              <div class="similar-card" onclick="window.location.href='manga.html?id=${rec.id}'">
                <img src="${rec.couverture}" alt="${rec.titre}" class="similar-cover" onerror="this.src='https://via.placeholder.com/120x180/1a1a1a/e63946?text=${encodeURIComponent(rec.titre)}'">
